...
Data used for the illustrative application are part of a larger project on the social-emotional development of school-age children, which was approved by the Ethics Committee of the School of Psychology at the University of Padova (protocol \#[1838-2016]). All materials and data are available at \url{https://doi.org/10.17605/OSF.IO/JKMDF}, GitHub repository \url{https://github.com/ClaudioZandonella/Attachment}.
