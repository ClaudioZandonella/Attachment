...
Each theoretical perspective was formalized into a different informative hypotheses taking into account the it own theoretical tenets, main evidence in the literature, and authors' clinical experience in the field.
