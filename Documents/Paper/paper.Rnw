...
In the previous section we compute the adjusted prior and the posterior of the vector of transformed parameters $\bm{\beta}$, respectively
\begin{equation}
