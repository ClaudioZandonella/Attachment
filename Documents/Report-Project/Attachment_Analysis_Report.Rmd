...
```{r}
ggplot(data_munged) +
  geom_bar(aes(x = externalizing_sum, fill = gender), alpha = 0.7) +
  facet_grid(gender ~ .)
```
...
```{r}
ggplot(data_munged) +
  geom_bar(aes(x = internalizing_sum, fill = gender), alpha = 0.7) +
  facet_grid(gender ~ .)
```
...
prop.table(table(data_cluster$cluster_mother))

prop.table(table(data_cluster$cluster_mother,
                 data_cluster$gender),2) 

summary(table(data_cluster$cluster_mother,
              data_cluster$gender))
```
...
prop.table(table(data_cluster$cluster_father))

prop.table(table(data_cluster$cluster_father,
                 data_cluster$gender),2) 

summary(table(data_cluster$cluster_father,
              data_cluster$gender))
```
