...
In this chapter, first, we describe the sample included in the study. Subsequently, we present the results of the cluster analysis to classify the different attachment patterns.
...
Externalizing problems according to attachment styles are reported in Table~\@ref(tab:table-cluster-ext).
...
Internalizing problems according to attachment styles are reported in Table~\ref(tab:table-cluster-ext).
