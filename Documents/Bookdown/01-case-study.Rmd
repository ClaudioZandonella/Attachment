...
In this chapter, we describe the sample included in the study. First we describe the aim of the study. Subsequently, we present general information about the sample and the results of the cluster analysis to classify the different attachment patterns. Finally, we consider children's social-emotional problems.

## Aim of the Study

The aim of the study is to compare the different theoretical perspectives regarding the role of mother attachment and father attachment on children's social emotional development. In the literature, four different main theoretical perspectives have been identified [@brethertonFathersAttachmentTheory2010]:

- **Monotropy Theory** - only the mother has an impact on children's development.
- **Hierarchy Theory** - the mother has a greater impact on children development than the  the father.
