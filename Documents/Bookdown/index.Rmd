...
- **Chapter \@ref(ext) - Externalizing Problems.** The analyses regarding externalizing problems are presented. First, we conduct the analysis following the traditional NHST approach. Subsequently, we consider Bayesian Model Comparison using the WAIC and LOO as criteria. Finally, we consider the Bayes Factor with encompassing prior approach.
