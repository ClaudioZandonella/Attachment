...
In this section, the analyses to evaluate the different role of mother attachment and father attachment on children's externalizing problems are presented following three different approaches.
...
- **Chapter \@ref(int) - Internalizing Problems.** The analyses regarding internalizing problems are presented. The analyses follow the same structure as the case of externalizing problems. Thus, only differences will be highlighted.
